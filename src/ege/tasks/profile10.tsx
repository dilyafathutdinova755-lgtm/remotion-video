...
const base = (id: string, hook: string[], problemSize = 44) => ({
  id,
  number: 10,
  subject: SUBJECT,
  hook,
...
export const twoCars24: TaskDef = {
  ...base("Prof10TwoCars24", ["Первая половина —", "24 км/ч"], 42),
...
export const overtake: TaskDef = {
  ...base("Prof10Overtake", ["Обогнал на шоссе", "Сколько между ними?"], 46),
...
export const cyclist75: TaskDef = {
  ...base("Prof10Cyclist75", ["Отстал на 6 часов", "Какая скорость?"], 44),
...
export const mixThree: TaskDef = {
  ...base("Prof10Mix3", ["Три раствора в один", "Сколько процентов?"], 42),
...
export const alloys350: TaskDef = {
  ...base("Prof10Alloys350", ["Два сплава", "На сколько разница?"], 44),
...
export const dilute: TaskDef = {
  ...base("Prof10Dilute", ["Долили воды", "Что с концентрацией?"], 44),
...
export const details345: TaskDef = {
  ...base("Prof10Details345", ["345 и 476 деталей", "Кто быстрее?"], 42),
...
export const pumps: TaskDef = {
  ...base("Prof10Pumps", ["Три насоса разом", "За сколько минут?"], 44),
...
export const fence: TaskDef = {
  ...base("Prof10Fence", ["Каждый день", "красят больше"], 44),
