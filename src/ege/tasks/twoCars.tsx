...
export const twoCars: TaskDef = {
  ...
  tokens: [
    ...
    art(["car", "car"], "два автомобиля"),
    ...w("Первый проехал с постоянной скоростью весь путь."),
    ...w("Второй проехал первую половину пути со скоростью, меньшей скорости первого на 13 км/ч,"),
    num("13", "км/ч"),
    ...w("а вторую половину пути — со скоростью 78 км/ч,"),
    num("78", "км/ч"),
    ...w("в результате чего прибыл в пункт B одновременно с первым автомобилем."),
    ...w("Найдите скорость первого автомобиля, если известно, что она больше 48 км/ч."),
    question(),
  ],
  problemSize: 42,
  timerSize: 30,
  ...
  solutions: [
    {
      ...
      Component: makeSolution({
        ...
        items: [
          line(
            <>
              Пусть скорость первого <V>x</V> км/ч, тогда на первой половине второй ехал{" "}
              <V>x</V> − 13.
            </>,
          ),
          line(<>Времена в пути равны, а путь у обоих один и тот же — он сокращается:</>),
          card(
            <>
              <Frac num="1" den={<V>x</V>} />
              <span style={{ margin: "0 14px" }}>=</span>
              <Frac num="1" den={<>2(<V>x</V> − 13)</>} />
              <span style={{ margin: "0 14px" }}>+</span>
              <Frac num="1" den="156" />
            </>,
            { size: 46 },
        ...
        items: [
          ...
          card(
            <>
              по условию <V>x</V> &gt; 48
              <span style={{ margin: "0 20px" }}>⟹</span>
              <V>x</V> = <span style={{ color: "#1d4ed8", fontWeight: 700 }}>52</span>
            </>,
            { accent: true, size: 42 },
          ),
        ],
  ...
  answerFormula: <>156 : 52 = 3 ч&nbsp;&nbsp;и&nbsp;&nbsp;78 : 39 + 78 : 78 = 3 ч</>,
  answer: "52",
  unit: "км/ч",
