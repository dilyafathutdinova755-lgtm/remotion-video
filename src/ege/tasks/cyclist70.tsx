...
export const cyclist70: TaskDef = {
  ...
  tokens: [
    ...
    ...w(
      "На следующий день он отправился обратно в A со скоростью на 3 км/ч больше прежней.",
    ),
  ...
  solutions: [
    {
      ...
      Component: makeSolution({
        ...
        items: [
          line(
            <>
              Пусть скорость из A в B равна <V>v</V> км/ч, тогда обратно —{" "}
              <V>v</V> + 3.
            </>,
          ),
          line(
            <>Обратный путь вместе с остановкой занял столько же времени:</>,
          ),
          card(
            <>
