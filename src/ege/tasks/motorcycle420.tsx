...
export const motorcycle420: TaskDef = {
  ...
  tokens: [
    ...
    art(["car"], "автомобиль"),
    ...w("а через 1 час следом за ним со скоростью 80 км/ч выехал мотоциклист,"),
    num("80", "км/ч"),
    art(["moto"], "мотоциклист"),
    ...w("догнал автомобиль в городе C и повернул обратно."),
    ...w("Когда он вернулся в A, автомобиль прибыл в B. Найдите расстояние от A до C."),
    question(),
  ],
  problemSize: 42,
  timerSize: 31,
  ...
  solutions: [
    {
      ...
      Component: makeSolution({
        ...
        items: [
          ...
          line(<>Обратно в A он вернулся ровно тогда, когда автомобиль пришёл в B:</>),
          card(
            <>
    ...
    },
    {
      ...
      Component: makeSolution({
        ...
        items: [
          line(
            <>
              Из первого уравнения <V>v</V> = 80<V>d</V> / (80 + <V>d</V>). Подставляем во второе:
            </>,
          ),
          card(
            <>
  ...
  answerFormula: <>автомобиль: 420 : 60 = 7 ч,&nbsp;&nbsp; мотоцикл: 1 + 2 · 240 : 80 = 7 ч</>,
  answer: "240",
  unit: "км",
